...
void HAL_TIM_MspPostInit(TIM_HandleTypeDef* htim)
{
  ...
  if(htim->Instance==TIM3)
  {
    ...
    PB4(NJTRST)     ------> TIM3_CH1
    */
    GPIO_InitStruct.Pin = SERVO_CAMARA_Pin|GPIO_PIN_1|GPIO_PIN_4;
...
void HAL_UART_MspInit(UART_HandleTypeDef* huart)
{
  ...
  */
    ...
    PC7     ------> USART6_RX
    */
    GPIO_InitStruct.Pin = USART6_TX_DATA_Pin|USART6_RX_DATA_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
...
void HAL_UART_MspDeInit(UART_HandleTypeDef* huart)
{
  ...
  else if(huart->Instance==USART2)
  {
    ...
    PA3     ------> USART2_RX
    */
    HAL_GPIO_DeInit(GPIOA, USART2_TX_GNSS_Pin|USART2_RX_GNSS_Pin);
  ...
  else if(huart->Instance==USART6)
  {
    ...
    PC7     ------> USART6_RX
    */
    HAL_GPIO_DeInit(GPIOC, USART6_TX_DATA_Pin|USART6_RX_DATA_Pin);
